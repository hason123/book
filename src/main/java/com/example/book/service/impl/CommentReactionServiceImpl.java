...
public class CommentReactionServiceImpl {
    ...
    public CommentReactionServiceImpl(CommentReactionRepository commentReactionRepository, UserServiceImpl userServiceImpl, UserRepository userRepository, CommentRepository commentRepository) {
    ...
    public void likeComment(Long commentId) {
        ...
        if (commentReactionRepository.findByUser_UserIdAndComment_CommentId(currentUserID, commentId) != null) {
            Comment comment = commentRepository.findById(commentId).orElseThrow(() -> new ResourceNotFoundException("Comment does not exist!"));
            ...
            commentReaction.setUser(userRepository.findById(currentUserID).orElseThrow(() -> new ResourceNotFoundException("User does not exist!")));
